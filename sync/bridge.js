/* Joins the app's classic scripts to kidsync, which is an ES module.
   ...
   or simply being offline, which for this app is a normal Tuesday — takes the
   whole page down with it. This way a failed load is one console line and a
   session that runs exactly as it always did.
...
/* App.init runs on DOMContentLoaded and registers first, so the screens exist
